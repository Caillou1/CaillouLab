	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Option:  Refraction Model:None,Box,Sphere:None
				...
				Box:HideOption:    Blending Mode
				Box:HideOption:    Blend Preserves Specular
				Box:ShowPort:GBuffer:Thickness
				Box:ShowPort:GBuffer:Refraction Index
				Box:ShowPort:GBuffer:Refraction Color
				Box:ShowPort:GBuffer:Refraction Distance
				Box:SetDefine:_HAS_REFRACTION 1
				Box:SetDefine:_REFRACTION_PLANE 1
				Box:RemoveDefine:_REFRACTION_SPHERE 1
				Sphere:HideOption:    Blending Mode
				Sphere:HideOption:    Blend Preserves Specular
				Sphere:ShowPort:GBuffer:Thickness
				Sphere:ShowPort:GBuffer:Refraction Index
				Sphere:ShowPort:GBuffer:Refraction Color
				Sphere:ShowPort:GBuffer:Refraction Distance
			...
			Option:Alpha Clipping:false,true:false
				...
				true:SetDefine:GBuffer:SHADERPASS_GBUFFER_BYPASS_ALPHA_TEST 1
				true:SetDefine:Forward:SHADERPASS_FORWARD_BYPASS_ALPHA_TEST 1
				true:SetDefine:_ALPHATEST_ON 1
				true:ShowOption:  Use Shadow Threshold
				true:ShowPort:GBuffer:Alpha Clip Threshold
				false:RemoveDefine:GBuffer:SHADERPASS_GBUFFER_BYPASS_ALPHA_TEST 1
				false:RemoveDefine:Forward:SHADERPASS_FORWARD_BYPASS_ALPHA_TEST 1
			...
			Option:DOTS Instancing:false,true:false
				true:SetDefine:_DOTS_INSTANCING 1
				false:RemoveDefine:_DOTS_INSTANCING 1
		...
		*/
		...
		Pass
		{
			...
			void BuildSurfaceData( FragInputs fragInputs, inout PrePassSurfaceDescription surfaceDescription, float3 V, out SurfaceData surfaceData, out float3 bentNormalWS )
			{
				ZERO_INITIALIZE( SurfaceData, surfaceData );
				surfaceData.perceptualSmoothness = surfaceDescription.Smoothness;
					...
					)
			{
				...
				#ifdef _ALPHATEST_PREPASS_ON
				surfaceDescription.AlphaClipThresholdDepthPrepass = /*ase_frag_out:Alpha Clip Threshold Depth Prepass;Float;33;-1;_AlphaClipDepthPrespass*/0.5/*end*/;
				#endif
		...
		Pass
		{
			...
			void BuildSurfaceData( FragInputs fragInputs, inout PostPassSurfaceDescription surfaceDescription, float3 V, out SurfaceData surfaceData, out float3 bentNormalWS )
			{
				ZERO_INITIALIZE( SurfaceData, surfaceData );
				surfaceData.perceptualSmoothness = surfaceDescription.Smoothness;
